...
├── tests/                                  # TESTS (Google Test) — 324 tests
│   ├── CMakeLists.txt
│   ├── error_test.cpp
│   ├── types_test.cpp
│   ├── value_test.cpp
...
324 tests across 13 test files. Uses Google Test (fetched via CMake FetchContent).
...
| `document_test.cpp` | 182 | Document core, merge, serialization, sync, patches, time travel, cursors, marks, thread safety, conflict resolution, list concurrency, counters, edge cases |
