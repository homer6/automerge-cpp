...
| 5b | 11A.3b Actor table cache | 20 min | +1.2-1.5x save_large |
...
| Benchmark | v0.3.0 (baseline) | v0.4.0 (est.) | Speedup |
|-----------|-------------------|---------------|---------|
| map_put (single) | 876 K ops/s | ~1.3 M ops/s | 1.5x |
| map_put_batch/1000 | 3.05 M ops/s | ~4.9 M ops/s | 1.6x |
| map_get | 27.1 M ops/s | ~49 M ops/s | 1.8x |
| list_insert_append | 7.1 K ops/s | ~92 K ops/s | 13x |
| list_insert_front | 13.5 K ops/s | ~189 K ops/s | 14x |
| list_get (1000 elem) | 2.78 M ops/s | ~19 M ops/s | 7x |
| text_splice_bulk (100 chars) | 9.3 K chars/s | ~232 K chars/s | 25x |
| save (100 keys, 1 change) | 13.2 K ops/s | ~22 K ops/s | 1.7x |
| load (100 keys, 1 change) | 27.6 K ops/s | ~47 K ops/s | 1.7x |
| save_large (1000 items) | 427 B/s | ~10 KiB/s | 25x |
| merge (10+10 puts) | 258 K ops/s | ~516 K ops/s | 2x |
| sync_full_round_trip | 4.3 K ops/s | ~20 K ops/s | 4.7x |
| cursor_resolve | 2.04 M ops/s | ~13.5 M ops/s | 6.6x |
